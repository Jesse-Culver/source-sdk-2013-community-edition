...
sampler _Sampler_00		: register( s0 ); //smBaseTex
sampler _Sampler_01		: register( s1 ); //smNormalMap
sampler _Sampler_02		: register( s2 ); //smGloss
sampler _Sampler_03		: register( s3 ); //smRefl
sampler _Sampler_04		: register( s4 ); //smCubemap
...
// In the order that GetPBS takes args
struct PS_INPUT
{
...
PS_OUTPUT main( const PS_INPUT In )
{
	...
	//Out.vColor_0 = _var0;
	Out.vColor_0 = tex2D( _Sampler_00, In.vTexCoord_0 );
	return Out;
}